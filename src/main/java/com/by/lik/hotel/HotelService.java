...
public class HotelService {
	...
	public synchronized List<Hotel> findAll(String nameFilter, String addressFilter) {
		...
		for (Hotel hotel : hotels.values()) {
			try {
				boolean passesFilter = ((nameFilter == null || nameFilter.isEmpty()	|| hotel.getName().toLowerCase().contains(nameFilter.toLowerCase())) &&
						(addressFilter == null || addressFilter.isEmpty() || hotel.getAddress().toLowerCase().contains(addressFilter.toLowerCase())));
